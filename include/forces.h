...
/**
 * Frees the auxiliary data associated with a body.
 * This function should be called to clean up memory when a body is removed from
 * the scene.
 *
 * @param aux the auxiliary data to free
 */
void body_aux_free(void *aux);

/**
 * Retrieves a list of bodies from the auxiliary data.
 * This function can be used to access the bodies associated with a force
 * creator.
 *
 * @param aux the auxiliary data containing the bodies
